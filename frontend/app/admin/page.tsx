...
function AdminUserDashboard() {
  ...
  return (
    <div className="bg-[#F9F4EC] dark:bg-[#111510] text-[#1A1A1A] dark:text-stone-200 min-h-[90vh] py-16 px-5 md:px-10 transition-colors duration-300 font-sans">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-[#2D5A27]/10 dark:border-white/10 pb-6">
          <div>
            <span className="text-[10px] font-black tracking-widest text-[#2D5A27] dark:text-brand-green-light uppercase font-mono">
              HỆ THỐNG QUẢN TRỊ ADMIN (ROLE: {adminProfile?.role})
            </span>
        ...
        {message && (
          <div className={`p-4 border text-xs font-bold ${
            message.type === 'success' 
              ...
              : 'bg-rose-50 dark:bg-rose-950/20 border-rose-250 dark:border-rose-800 text-rose-800 dark:text-rose-300'
          }`}>
            {message.text}
          </div>
        )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-[#171E15] border border-[#2D5A27]/10 dark:border-white/10 p-6 flex items-center justify-between shadow-xs">
            <div className="space-y-1">
              <p className="text-[9px] text-brand-muted uppercase tracking-widest font-black font-mono">Tổng Thành Viên</p>
              <h3 className="text-xl md:text-2xl font-black text-[#1A1A1A] dark:text-white">{totalCount} Khách</h3>
          ...
          <div className="bg-white dark:bg-[#171E15] border border-[#2D5A27]/10 dark:border-white/10 p-6 flex items-center justify-between shadow-xs">
            <div className="space-y-1">
              <p className="text-[9px] text-brand-muted uppercase tracking-widest font-black font-mono">Thành viên VIP</p>
              <h3 className="text-xl md:text-2xl font-black text-[#C8953A] dark:text-amber-400">{vipCount} VIP</h3>
              <p className="text-[8px] text-[#C8953A]">Sở hữu hạng Bạc/Vàng/Kim Cương</p>
            </div>
          ...
          <div className="bg-white dark:bg-[#171E15] border border-[#2D5A27]/10 dark:border-white/10 p-6 flex items-center justify-between shadow-xs">
            <div className="space-y-1">
              <p className="text-[9px] text-brand-muted uppercase tracking-widest font-black font-mono">Nhân viên & Admin</p>
              <h3 className="text-xl md:text-2xl font-black text-indigo-800 dark:text-indigo-400">{staffCount} Nhân Sự</h3>
              <p className="text-[8px] text-brand-muted">Có quyền truy cập quản lý</p>
            </div>
          ...
          <div className="bg-white dark:bg-[#171E15] border border-[#2D5A27]/10 dark:border-white/10 p-6 flex items-center justify-between shadow-xs">
            <div className="space-y-1">
              <p className="text-[9px] text-brand-muted uppercase tracking-widest font-black font-mono">Hạng Tiêu Chuẩn</p>
              <h3 className="text-xl md:text-2xl font-black text-stone-700 dark:text-stone-300">{normalCount} Thường</h3>
              <p className="text-[8px] text-brand-muted">Tài khoản chưa nâng cấp</p>
            </div>
