...
async function run() {
  ...
  // Prepare the third batch of 5 screenshot orders with randomized timestamps from targetDates between 7:30 and 16:30
  const ordersToInsert = [
    ...
    {
      customerName: 'Nguyễn Thị Loan',
      customerPhone: getRandomPhone(),
      customerAddress: 'Chung cư Golden Land, 275 Nguyễn Trãi, Thanh Xuân, Hà Nội',
      paymentMethod: 'COD',
      paymentStatus: 'paid',
      orderStatus: 'completed',
      totalAmount: 180000,
    ...
    {
      customerName: 'Nguyễn Hữu Hoàng Thân',
      customerPhone: getRandomPhone(),
      customerAddress: '82 Trần Phú, Hải Châu, Đà Nẵng',
      paymentMethod: 'COD',
      paymentStatus: 'paid',
      orderStatus: 'completed',
      totalAmount: 170000,
  ...
  console.log(`Inserting third batch of exactly 5 orders with date/time constraints (COD)...`);
