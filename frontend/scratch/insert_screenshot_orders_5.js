...
async function run() {
  ...
  // Prepare the fifth batch of 5 screenshot orders with randomized timestamps from targetDates between 7:30 and 16:30
  const ordersToInsert = [
    {
      customerName: 'Hoàng Đức Phương',
      customerPhone: getRandomPhone(),
      customerAddress: 'Số 42 Ngõ 191 Minh Khai, Hai Bà Trưng, Hà Nội',
      paymentMethod: 'COD',
      paymentStatus: 'paid',
    ...
    },
    {
      ...
      createdAt: getRandomTimeWithinConstraint(getRandomElement(targetDates)),
      items: [
        { productId: 'bun-cam-cao-tuyen', name: 'BÚN CẨM CAO TUYỀN', selectedWeight: '500g', quantity: 4, price: 35000 }
      ]
    },
    {
      customerName: 'Thiều Xuân Giang',
      customerPhone: getRandomPhone(),
      ...
      createdAt: getRandomTimeWithinConstraint(getRandomElement(targetDates)),
      items: [
        { productId: 'bun-ngu-sac-cao-tuyen', name: 'BÚN NGŨ SẮC CAO TUYỀN', selectedWeight: '500g', quantity: 2, price: 40000 }
      ]
    },
    {
      customerName: 'Nguyễn An Ninh',
      customerPhone: getRandomPhone(),
    ...
    {
      customerName: 'Nguyễn Chiến Thắng',
      customerPhone: getRandomPhone(),
  ...
  console.log(`Inserting fifth batch of exactly 5 orders with date/time constraints (COD)...`);
