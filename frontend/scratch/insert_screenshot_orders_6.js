...
async function run() {
  ...
  // Prepare the sixth batch of 5 screenshot orders with randomized timestamps from targetDates between 7:30 and 16:30
  const ordersToInsert = [
    ...
    {
      customerName: 'Thiều Quang Thịnh',
      customerPhone: getRandomPhone(),
  ...
  console.log(`Inserting sixth batch of exactly 5 orders with date/time constraints (COD)...`);
