...
async function run() {
  ...
  // Prepare the seventh batch of 5 screenshot orders with randomized timestamps from targetDates between 7:30 and 16:30
  const ordersToInsert = [
    {
      customerName: 'Đặng Hồng Sơn',
    ...
    },
    {
      ...
      createdAt: getRandomTimeWithinConstraint(getRandomElement(targetDates)),
      items: [
        { productId: 'bun-ngo-premium', name: 'BÚN NGÔ KHÔ PREMIUM', selectedWeight: '500g', quantity: 3, price: 32000 }
      ]
    },
    {
  ...
  console.log(`Inserting seventh batch of exactly 5 orders with date/time constraints (COD)...`);
