...
async function run() {
  ...
  // Prepare the eighth batch of 5 screenshot orders with randomized timestamps from targetDates between 7:30 and 16:30
  const ordersToInsert = [
    {
      customerName: 'Vũ Thị Thùy Dung',
      customerPhone: getRandomPhone(),
      customerAddress: 'Số 12 Ngõ 45 Kim Mã, Ba Đình, Hà Nội',
      paymentMethod: 'COD',
      paymentStatus: 'paid',
      ...
      items: [
        { productId: 'bun-den-cao-tuyen', name: 'BÚN ĐEN CAO TUYỀN', selectedWeight: '500g', quantity: 2, price: 40000 },
        { productId: 'bun-cam-cao-tuyen', name: 'BÚN CẨM CAO TUYỀN', selectedWeight: '500g', quantity: 1, price: 35000 }
      ]
    },
    {
      customerName: 'Vũ Khánh Hòa',
      customerPhone: getRandomPhone(),
      customerAddress: 'Số 102 Ngõ 290 Kim Mã, Ba Đình, Hà Nội',
      paymentMethod: 'COD',
      paymentStatus: 'paid',
      orderStatus: 'completed',
      totalAmount: 120000,
      createdAt: getRandomTimeWithinConstraint(getRandomElement(targetDates)),
      items: [
        { productId: 'bun-ngo-premium', name: 'BÚN NGÔ KHÔ PREMIUM', selectedWeight: '500g', quantity: 4, price: 32000 }
      ]
    },
    {
      customerName: 'Nguyễn Văn Linh',
      customerPhone: getRandomPhone(),
      customerAddress: 'Số 15 Hàng Đào, Hoàn Kiếm, Hà Nội',
      paymentMethod: 'COD',
      paymentStatus: 'paid',
      orderStatus: 'completed',
      totalAmount: 150000,
      createdAt: getRandomTimeWithinConstraint(getRandomElement(targetDates)),
      items: [
        { productId: 'bun-den-cao-tuyen', name: 'BÚN ĐEN CAO TUYỀN', selectedWeight: '500g', quantity: 3, price: 40000 },
        { productId: 'bun-ngo-premium', name: 'BÚN NGÔ KHÔ PREMIUM', selectedWeight: '500g', quantity: 1, price: 32000 }
      ]
    },
    {
      customerName: 'Vũ Tùng Lâm',
      customerPhone: getRandomPhone(),
      customerAddress: '235 Nguyễn Văn Cừ, Long Biên, Hà Nội',
      paymentMethod: 'COD',
      paymentStatus: 'paid',
      orderStatus: 'completed',
      totalAmount: 128000,
      createdAt: getRandomTimeWithinConstraint(getRandomElement(targetDates)),
      items: [
        { productId: 'bun-ngo-premium', name: 'BÚN NGÔ KHÔ PREMIUM', selectedWeight: '500g', quantity: 2, price: 32000 },
        { productId: 'bun-cam-cao-tuyen', name: 'BÚN CẨM CAO TUYỀN', selectedWeight: '500g', quantity: 2, price: 35000 }
      ]
    },
    {
      customerName: 'Lê Đăng Khoa',
      customerPhone: getRandomPhone(),
      customerAddress: 'Số 9 Tôn Thất Thuyết, Cầu Giấy, Hà Nội',
      paymentMethod: 'COD',
      paymentStatus: 'paid',
      orderStatus: 'completed',
      totalAmount: 120000,
      createdAt: getRandomTimeWithinConstraint(getRandomElement(targetDates)),
      items: [
        { productId: 'bun-ngu-sac-cao-tuyen', name: 'BÚN NGŨ SẮC CAO TUYỀN', selectedWeight: '500g', quantity: 3, price: 40000 }
      ]
    }
  ];

  console.log(`Inserting eighth batch of exactly 5 orders with date/time constraints (COD)...`);
